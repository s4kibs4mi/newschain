...
//
// Solidity: function transfer(address newOwner) payable returns()
func (_Contracts *ContractsTransactor) Transfer(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _Contracts.contract.Transact(opts, "transfer", newOwner)
}

// Transfer is a paid mutator transaction binding the contract method 0x1a695230.
//
// Solidity: function transfer(address newOwner) payable returns()
func (_Contracts *ContractsSession) Transfer(newOwner common.Address) (*types.Transaction, error) {
	return _Contracts.Contract.Transfer(&_Contracts.TransactOpts, newOwner)
}

// Transfer is a paid mutator transaction binding the contract method 0x1a695230.
//
// Solidity: function transfer(address newOwner) payable returns()
func (_Contracts *ContractsTransactorSession) Transfer(newOwner common.Address) (*types.Transaction, error) {
	return _Contracts.Contract.Transfer(&_Contracts.TransactOpts, newOwner)
}
